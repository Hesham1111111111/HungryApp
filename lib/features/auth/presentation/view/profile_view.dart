...
import 'package:hungry/features/auth/presentation/view/widget/profile/custom_profile_filed.dart';
...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      onRefresh: authCubit.getProfileData,
      child: Scaffold(
